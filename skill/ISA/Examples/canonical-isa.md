...
- [ ] ISC-38: Anti: regression — first-page browse load makes zero third-party network requests (no analytics beacon, no font CDN, no ad-tech) (probe: devtools network panel on first load, 0 third-party requests).
...
- isc: ISC-38
  ...
  threshold: 0
  tool: devtools network panel at /browse
```
