...
- [x] ISC-11: out of scope — `arxiv.ts --download` is rejected with usage and exit 2.
- [x] ISC-12: regression — never makes more than 3 concurrent requests against arxiv API.
